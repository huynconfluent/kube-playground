# MDS with LDAP based Userstore

This is an example of LDAP being the backing Userstore for MDS.
...
cd kube-playground
export BASE_DIR=$(pwd)
./start.sh -v 3.0.0 -e ldap
```

2. Deploy Kubernertes Secrets

```
cd examples/mds/ldap_userstore
./setup.sh
```
...
You can login using one of the ldap users
